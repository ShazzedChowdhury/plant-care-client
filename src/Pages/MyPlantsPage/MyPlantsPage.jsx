...
const MyPlantsPage = () => {
    ...
    const deleteEntry = (id) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          fetch(`https://b11-a10-mango-plant-care-server.vercel.app/my-plants/${id}`, {
            method: "DELETE",
          })
            .then((res) => res.json())
            .then((data) => {
    ...
    return (
      <section className="max-w-7xl px-5 md:-10 mx-auto pt-10 min-h-[calc(100vh-68px-395px)] py-10">
